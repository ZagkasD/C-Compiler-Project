...
#Metafora ston t0 diey8ynsh mh topikhs (NON-local) , mh katholikhs metablhths
    ...
    def loadvr(variable, register):
        ...
        #Stores the data: source register , target variable
...
def main():
    ...
    input_file = open('test.ci','r')
    input_file_name = 'test.ci'    # will be used to create the .int, .c, .asm, files with the same name as the input file
